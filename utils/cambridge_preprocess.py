...
parser.add_argument("--project", type=str, default="true",
                    choices=["true", "false"], help="project")
parser.add_argument("--scene", type=str, default="GreatCourt",
                    choices=["", "GreatCourt", "KingsCollege", "OldHospital", "ShopFacade4", "ShopFacade", "StMarysChurch5", "StMarysChurch_1.5", "StMarysChurch",
                             "GreatCourt_2.75", "GreatCourt_3.00", "GreatCourt_3.25", "GreatCourt_3.50",
                             "OldHospital_20200919_clean_1.5", "OldHospital_20200919_clean_2.0", "OldHospital_20200919_clean_2.5",
                             "OldHospital_ori", "ShopFacade2", "StMarysChurch_20200919_seed_res_0.65"], help="scene")
